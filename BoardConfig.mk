...
-include vendor/avvio/795/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_BOARD_NAME := 795
...
BOARD_CUSTOM_BOOTIMG_MK := device/avvio/795/bootimg.mk
BOARD_MKBOOTIMG_ARGS := --mtk 1

TARGET_PREBUILT_KERNEL := device/avvio/795/prebuilt/kernel
TARGET_RECOVERY_INITRC := device/avvio/795/recovery/init.mt6582.rc
TARGET_RECOVERY_FSTAB := device/avvio/795/recovery/recovery.fstab
